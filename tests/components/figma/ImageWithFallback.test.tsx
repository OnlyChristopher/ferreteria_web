...
import * as Module from '/src/components/figma/ImageWithFallback.tsx'
import { render } from '@testing-library/react'

// Smoke test auto-generado para ImageWithFallback
test('renders ImageWithFallback without crashing', () => {
